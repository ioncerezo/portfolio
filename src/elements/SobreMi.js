...
function SobreMi() {
    ...
    return (
        ...
        <p className='text-justify lg:text-2xl md:text-center py-2'>¡Hola! Soy <span className='font-bold lg:hover:text-[#CD5C5C] transition-all'>desarrollador Full Stack</span>, actualmente viviendo en Tenerife, Islas Canarias.</p>
        <p className='my-10 max-w-[1220px] mx-auto text-justify md:text-center'>Desde pequeño he sido un <span className='font-bold'>apasionado del mundo del software libre y la tecnología</span>, aunque acabé desarrollando mi formación académica en otra de mis pasiones; el ámbito de la <span className='font-bold'>educación e integración social.</span> Tras meditarlo durante un tiempo, decidí dejar mi trabajo en septiembre del 2022 para volcarme en el <span className='font-bold'>desarrollo web</span> y así meterme de lleno en esta apasionante sector dando un giro a mi carrera profesional.</p>
